...
function sc(a,b,c){a.L=1;a.v=tc(O(b));a.s=c;a.R=!0;uc(a,null)}function uc(a,b){a.F=Date.now();vc(a);a.A=O(a.v);var c=a.A,d=a.W;Array.isArray(d)||(d=[String(d)]);wc(c.i,"t",d);a.C=0;c=a.l.H;a.h=new pc;a.g=xc(a.l,c?b:null,!a.s);0<a.O&&(a.M=new J(y(a.Oa,a,a.g),a.O));Qb(a.U,a.g,"readystatechange",a.lb);b=a.H?ab(a.H):{};a.s?(a.u||(a.u="POST"),b["Content-Type"]="application/x-www-form-urlencoded",a.g.fa(a.A,a.u,a.s,b)):(a.u="GET",a.g.fa(a.A,a.u,null,b));$b(1);Tb(a.j,a.u,a.A,a.m,a.W,a.s)}
...
function xc(a,b,c){if(b&&!a.H)throw Error("Can't create secondary domain capable XhrIo object.");b=c&&a.Ga&&!a.ua?new X(new yd({mb:!0})):new X(a.ua);b.Na(a.H);return b}function $d(){}n=$d.prototype;n.Aa=function(){};n.za=function(){};n.ya=function(){};n.xa=function(){};n.Ua=function(){};function ae(){if(E&&!(10<=Number(Ua)))throw Error("Environmental error: no available transport.");}ae.prototype.g=function(a,b){return new Y(a,b)};
...
X.prototype.getResponseText=X.prototype.ia;X.prototype.send=X.prototype.fa;X.prototype.setWithCredentials=X.prototype.Na;module.exports.createWebChannelTransport=function(){return new ae};module.exports.getStatEventTarget=function(){return Yb()};module.exports.ErrorCode=dc;module.exports.EventType=ec;module.exports.Event=L;module.exports.Stat={vb:0,yb:1,zb:2,Sb:3,Xb:4,Ub:5,Vb:6,Tb:7,Rb:8,Wb:9,PROXY:10,NOPROXY:11,Pb:12,Lb:13,Mb:14,Kb:15,Nb:16,Ob:17,rb:18,qb:19,sb:20};
module.exports.FetchXmlHttpFactory=yd;module.exports.WebChannel=hc;module.exports.XhrIo=X;}).apply(typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : {});
